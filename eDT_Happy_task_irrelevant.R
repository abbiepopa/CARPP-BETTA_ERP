...
hap_PD_22qa<-hap_PD_22q[which(hap_PD_22q$bini==5),]
hap_N2PC_TDa<-hap_N2PC_TD[which(hap_N2PC_TD$bini==5),]
hap_PD_TDa<-hap_PD_TD[which(hap_PD_TD$bini==5),]
...
write.csv(happy_DT_wide_trim, "happy_DT_wide_task_irrelevant.csv", row.names=F)