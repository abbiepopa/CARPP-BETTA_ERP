setwd("~/Documents/ERP Analyses/data/calm_measures_170330")
...
#happy
hap_N2PC_22q<-read.table("eDT_Calm_22q_N2PC_170330.txt", header=T, sep="\t")
hap_PD_22q<-read.table("eDT_Calm_22q_Pd_170330.txt", header=T, sep="\t")

hap_N2PC_TD<-read.table("eDT_Calm_TD_N2PC_170330.txt", header=T, sep="\t")
hap_PD_TD<-read.table("eDT_Calm_TD_Pd_170330.txt", header=T, sep="\t")
...
write.csv(out, "eDT_calm_happy_distractors_out.csv",row.names=F)
write.csv(happy_DT, "eDT_calm_happy_distractors_long.csv",row.names=F)
write.csv(happy_DT_wide_trim, "eDT_calm_happy_distractors_wide.csv", row.names=F)