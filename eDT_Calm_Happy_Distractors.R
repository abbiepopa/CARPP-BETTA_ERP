...
#happy
hap_N2PC_22q<-read.table("eDT_calm_22q_N2PC_170607.txt", header=T, sep="\t")
hap_PD_22q<-read.table("eDT_calm_22q_Pd_170607.txt", header=T, sep="\t")

hap_N2PC_TD<-read.table("eDT_calm_TD_N2PC_170607.txt", header=T, sep="\t")
hap_PD_TD<-read.table("eDT_calm_TD_Pd_170607.txt", header=T, sep="\t")
